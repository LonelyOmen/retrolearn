...
serve(async (req) => {
  ...
  try {
    ...
    const geminiPrompt = `You are an educational research assistant. For the topic "${topic}", provide:

1. A detailed 2-3 paragraph overview explaining what this topic is, its importance, and key concepts
2. 5 practical beginner tips for learning this topic

Return your response in this exact JSON format:
{
  "overview": "Your detailed overview here",
  "tips": [
    "Practical tip 1",
    "Practical tip 2", 
    "Practical tip 3",
