...
import { ArrowLeft, Search, Loader2, ExternalLink, Users, Video, Image, Sparkles, Book } from "lucide-react";
...
const Learn = () => {
  ...
  const [activeTab, setActiveTab] = useState("ai-explorer");
            ...
            <div className="w-full max-w-6xl mx-auto space-y-12 animate-fade-in">
              ...
              <div className="space-y-4 text-center">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto">
                  Choose between AI-powered topic exploration or Wikipedia search
                </p>
              </div>

              {/* Tabs */}
              <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 h-12">
                <TabsTrigger value="ai-explorer" className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4" />
                  AI Explorer
                </TabsTrigger>
                <TabsTrigger value="wikipedia" className="flex items-center gap-2">
                  <Book className="w-4 h-4" />
                  Wikipedia
                </TabsTrigger>
              </TabsList>

              <TabsContent value="ai-explorer" className="space-y-8">
                {!result ? (
